...
ax1.scatter(d_steps, d_reward, color = "g", label="d_reward")
ax1.plot(d_steps, d_reward_a, color = "k", linestyle=linestyle, label="d_reward_average")
...
fig = plt.figure(3) 
ax1 = fig.add_subplot(211)
ax1.scatter(d_steps, d_loss, color = "g", label="d_loss")
ax1.plot(d_steps, d_loss_a, color = "k", linestyle=linestyle, label="d_loss_average")
ax1.legend(loc='upper right')
l_min = min(d_loss)
l_max = max(d_loss)
ax1.set_xlim(0, max(steps))
...
fig = plt.figure(4) 
ax1 = fig.add_subplot(211)
ax1.scatter(d_steps, d_total_loss, color = "g", label="d_total_loss")
ax1.plot(d_steps, d_total_loss_a, color = "k", linestyle=linestyle, label="d_total_loss_average")
ax1.legend(loc='upper right')
